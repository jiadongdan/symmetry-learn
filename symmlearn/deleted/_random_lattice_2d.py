...
def random_num_atoms_in_unit_cell(min_num_atoms_in_unit_cell, max_num_atoms_in_unit_cell, is_even, rng):
    if is_even:
        ...
        rand_multiplier = 1
    num_atoms_in_unit_cell = rng.integers(rand_bounds[0], rand_bounds[1], endpoint=True) * rand_multiplier
    return num_atoms_in_unit_cell
...
class RandomLattice:
    ...
    def generate_lattice(self, wallpaper_class, num_atoms=None, seed=None, debug=False):
        ...
        if num_atoms is None:
            ...
            min_num_atoms_in_unit_cell, max_num_atoms_in_unit_cell = [num_atoms, num_atoms]
        if debug:
            print(min_num_atoms_in_unit_cell, max_num_atoms_in_unit_cell)
        num_atoms_in_unit_cell = random_num_atoms_in_unit_cell(min_num_atoms_in_unit_cell,
                                                               max_num_atoms_in_unit_cell,
                                                               is_even=self.group["even"],
                                                               rng=rng1)
