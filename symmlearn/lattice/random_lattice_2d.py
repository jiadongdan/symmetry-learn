...
class RandomLattice:
    ...
    def __init__(self, supercell=[10,10,1], max_rotation_angle=90, atom_radius=.3, scale=1.):
    ...
    def generate_lattice(self, wallpaper_class, seed=None):
        ...
        ase_atoms = struct.to_ase() * self.supercell
        self.atoms = make_cell_square(ase_atoms)
